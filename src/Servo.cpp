...
Servo::Servo(Pca9685 &device, uint8_t pin, uint16_t min_pulse_us, uint16_t max_pulse_us, uint16_t neutral_pulse_us) :
_device(device),
_pin(pin),
...
void Servo::move_servo_to_degree(float target_pos_degree)
{
    ...
    this->_device.write_pulse_us(this->_pin, 0, pulse);
